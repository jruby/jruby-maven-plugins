...
public abstract class AbstractGemMojo extends AbstractJRubyMojo {
    ...
    protected void executeJRuby() throws MojoExecutionException,
        ...
        // gemsConfig.setUserInstall(userInstall);
    ...
    // for (final ArtifactRepository repo :
    ...
    // }
    //
    // private void setupGems(Collection<Artifact> artifacts, final boolean
    // resolve)
    ...
    // catch (final GemException e) {
    // throw new
    // MojoExecutionException("error creating artifact coordinate for jruby-openssl",
    // e);
    // }
    // }
    ...
    // final Map<String, Artifact> collectedArtifacts = new
    ...
    // .addArg("-l")
    // .addArg(extraFlag)
    // .addArgs(this.gemInitializeArgs)
    ...
    // throw new
    // MojoExecutionException("Unable to build project due to an invalid dependency version: "
    // + e.getMessage(),
    // e);
    // }
    // }
    //
    // private void resolve(final Artifact artifact) throws
