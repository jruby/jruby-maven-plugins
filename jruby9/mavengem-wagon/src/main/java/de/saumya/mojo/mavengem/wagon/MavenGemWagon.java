...
public class MavenGemWagon extends StreamWagon {
	...
	try {
		...
		System.err.println("WARNING: proxy support is not implemented - ignoring proxy settings" );
	    }

	    //TODO get this factory configured via maven
	    RubygemsFacadeFactory factory = new RubygemsFacadeFactory();
