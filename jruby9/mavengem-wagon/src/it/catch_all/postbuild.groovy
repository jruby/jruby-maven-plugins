...
[ "Downloaded: mavengem:http://rubygems.org/some/path/rubygems/jar-dependencies/0.2.6/jar-dependencies-0.2.6.pom", "Downloaded: mavengem:http://rubygems.org/some/path/rubygems/jar-dependencies/0.2.6/jar-dependencies-0.2.6.gem" ].each {
