...
import de.saumya.mojo.ruby.LauncherFactory;
...
public class EmbeddedLauncherTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        this.launcher = factory.getLauncher(true,
                                            classpathElements,
                                            env,
                                            new File("./pom.xml"),
                                            null);
    ...
    public void testExecution() throws Exception {
        this.launcher.execute("target/test-classes/test.rb",
                              "one",
                              "two",
                              "three");
    ...
    public void testExecutionWithOutput() throws Exception {
        ...
        this.launcher.execute(output,
                              "target/test-classes/test_with_output.rb",
                              "one",
                              "two",
                              "three");
    ...
    public void testScriptWithOutput() throws Exception {
        ...
        this.launcher.executeScript("test_with_output.rb",
                                    output,
                                    "one",
                                    "two",
                                    "three");
    ...
    public void testGem() throws Exception {
        ...
        this.launcher.executeScript("META-INF/jruby.home/bin/gem",
                                    output,
                                    "env");
